...
# from fastcrawler_ui import app
# from fastcrawler_ui.controllers.ws import ConnectionManager, Message
...
#         asyncio.run(self.manager.send_personal_message(message, websocket_mock))
